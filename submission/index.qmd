...
key-points:
  - The Swiss Federal Archives (SFA) has implemented Archipanion, powered by vitrivr, to enable AI-driven, content-based multimedia retrieval, significantly improving access to its digital film collection "Filmwochenschau (1940-1975)".
  - The Archipanion platform supports multilingual query processing and multiple search modes, allowing users to perform granular content searches and discover connections within the Schweizer Filmwochenschau collection.
